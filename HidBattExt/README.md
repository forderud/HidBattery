...
Windows 11 insider preview Build 29550.1000 includes improvements to also parse the Temperature & CycleCount parameters. This version also includes the HidBatt driver in the ARM64 version of Windows. This means that the HidBattExt driver is **no longer needed in Windows 11 builds >= 29550.1000**.
